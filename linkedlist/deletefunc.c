...
void deleteRear(NODE **first)
{
    ...
    {
        // iterate through the list ot get the last element, make elem->link=NULL free the last node while storing it in temp
        // check if the last elemrnt is null while not reaching it else you lose the prev element
